...
export default function Header() {
  ...
  return (
    <header className="w-full" style={{backgroundColor: '#f5f5f5'}}>
      <div className="max-w-[1440px] mx-auto py-6 sm:py-8 lg:py-12 px-4 sm:px-8 lg:px-0">
        {/* Mobile/Tablet: Flex Layout */}
        <div className="lg:hidden flex items-center justify-between">
          {/* Logo */}
          <Link href="/" className="flex-shrink-0 relative w-[119px] sm:w-[170px] h-[30px] sm:h-[42px]">
            <Image
              ...
              priority
              sizes="(max-width: 640px) 119px, (max-width: 1024px) 170px"
            />
          </Link>
          ...
          <button
            ...
            className="p-2 -mr-2 text-archive-slate hover:opacity-70 transition-opacity"
        ...
        {/* Desktop: Grid Layout */}
        <div className="hidden lg:grid grid-cols-[1fr_40%] gap-0">
          {/* Left column - Logo */}
          <div className="px-[80px] flex items-center">
            <Link href="/" className="flex-shrink-0 relative w-[238px] h-[60px]">
              <Image
                src="https://cdn.builder.io/api/v1/image/assets%2F5031849ff5814a4cae6f958ac9f10229%2Fd28207d51f894871ab0aee911d45e221?format=webp&width=800"
                alt="Art Investment Group Trust Logo"
                fill
          ...
          <div className="flex items-center justify-end pl-[80px]">
      ...
      {isMenuOpen && (
        <nav className="lg:hidden fixed top-0 right-0 left-0 bg-white border-b border-gallery-plaster shadow-md z-50" style={{marginTop: 'var(--header-height, auto)'}}>
          <div className="max-w-[1440px] mx-auto flex flex-col p-4 sm:p-6 gap-6">
            <Link
              href="/about"
