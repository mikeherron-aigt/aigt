    ...
    const createGlobe = () => {
      ...
      const readImageData = (imageData: Uint8ClampedArray) => {
        for (let i = 0, lon = -180, lat = 90; i < imageData.length; i += 4, lon++) {
          ...
          // Check if this is land (not water/ocean)
          // Works for both dark continents on light bg, and light continents on dark bg
          const brightness = (red + green + blue) / 3;
          const isLand = brightness < 150; // Darker pixels are land
