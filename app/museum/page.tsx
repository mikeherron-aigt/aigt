      ...
      <main>
        ...
        <section className="relative w-full h-[500px] sm:h-[600px] lg:h-[700px]">
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="w-full max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-20 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              {/* Left side - Title on image */}
              <div className="lg:block">
                <h1 
                  className="text-white font-serif text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-normal leading-tight"
                  style={{ fontFamily: "Georgia, serif" }}
                >
                  The John Dowling Jr.<br />
                  Museum of Contemporary Art
                </h1>
              </div>
              
              {/* Right side - White box with subtitle */}
              <div className="bg-white p-8 sm:p-10 lg:p-12 shadow-lg">
                <h2 
        ...
        {/* Introduction - Removed since it's now in the hero */}
        ...
        <section className="py-0">
          ...
          <div className="max-w-[1120px] mx-auto px-6 sm:px-8 lg:px-12 py-12 lg:py-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              {/* Left: Text Content */}
              <div>
        ...
        <section className="py-0">
          ...
          {/* Leadership Content - White background */}
          <div className="bg-white py-12 lg:py-20">
            <div className="max-w-[1120px] mx-auto px-6 sm:px-8 lg:px-12">
              
              {/* John Dowling Jr. Section */}
              <div className="mb-16 lg:mb-24">
                <h3 className="mb-2">John Dowling Jr.</h3>
                <p className="text-ledger-stone text-sm mb-8">Founder</p>
                
                {/* First paragraph - larger font */}
                <p className="text-lg lg:text-xl leading-relaxed mb-8" style={{ fontFamily: "Georgia, serif", color: "#252e3a" }}>
                ...
                {/* Second paragraph - regular font */}
                <p className="text-base lg:text-lg leading-relaxed" style={{ fontFamily: "Georgia, serif", color: "#252e3a" }}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                ...
                <div className="p-8 lg:p-10" style={{ backgroundColor: "#f5f5f5" }}>
                  <h3 className="mb-6">Museum Leadership</h3>
                  <p className="mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="font-serif text-base lg:text-lg" style={{ fontFamily: "Georgia, serif" }}>
                This is not a promise of immediacy.
              </p>
            </div>
