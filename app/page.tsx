    ...
    <div className="min-h-screen" style={{backgroundColor: '#f5f5f5'}}>
      ...
      <main>
        ...
        <div className="w-full h-[36px] relative hidden lg:block">
          {/* Left portion - Gallery Plaster - extends to dark green square */}
          <div className="absolute left-0 top-0 h-full bg-gallery-plaster" style={{width: 'calc(50vw + 112px + 32px)'}}></div>
