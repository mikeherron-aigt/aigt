    ...
    <div className="min-h-screen" style={{backgroundColor: '#f5f5f5'}}>
      ...
      <main>
        ...
        <div className="w-full h-[36px] relative hidden lg:block">
          ...
          <div className="absolute left-0 top-0 h-full bg-gallery-plaster" style={{width: 'calc(50% + 120px)'}}></div>
          {/* Right portion - Ledger Stone */}
          <div className="absolute top-0 h-full bg-ledger-stone" style={{left: 'calc(50% + 152px)', right: '0'}}></div>
          {/* Dark green square at intersection */}
          <div className="absolute top-0 w-8 h-full bg-deep-patina" style={{left: 'calc(50% + 120px)'}}></div>
        </div>
