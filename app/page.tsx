        ...
        <div className="max-w-[1440px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-0">
            ...
            <div className="relative h-[400px] sm:h-[500px] lg:h-[680px] overflow-hidden bg-gallery-plaster">
              ...
              {/* Decorative Elements */}
              <div className="absolute left-0 top-0 w-8 h-1/2 bg-white hidden lg:block"></div>
              <div className="absolute left-0 bottom-0 w-8 bg-ledger-stone hidden lg:block" style={{height: '25%'}}></div>
            </div>
          </div>
