              ...
              <div className="px-4 sm:px-8 lg:px-[80px] flex flex-col lg:flex-row justify-center items-stretch gap-6 lg:gap-[34px] w-full">
                  ...
                  <div className="fund-card">
                    <div className="fund-card-content">
                      ...
                      <Link href="/blue-chip-art-fund" className="cta-primary" style={{textDecoration: 'none', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', margin: 'auto 0', width: 'auto', alignSelf: 'flex-start'}}>
                        Learn More
                      </Link>
                    </div>
                  </div>
