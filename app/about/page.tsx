      ...
      <main>
            ...
            <div className="grid lg:grid-cols-[1fr_40%] gap-0">
              ...
              <div className="px-4 sm:px-8 lg:px-[80px] py-12 sm:py-16 lg:py-24 flex items-center">
                <div className="max-w-[711px]">
                  <h1>Stewardship Requires Accountability</h1>
                  <div className="hero-subtitle flex flex-col gap-4">
                    ...
                    <p>
                      Art Investment Group Trust is not operated anonymously. Decisions are made by people accountable for
                      long term outcomes.
                    </p>
                  </div>
                </div>
        ...
        <section className="w-full bg-white py-12 sm:py-16 lg:py-20 border-b border-gallery-plaster">
          <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[80px]">
            <div className="max-w-[711px]">
              <p>
                Art Investment Group Trust is a governed art investment platform focused on the acquisition, stewardship,
                and long term ownership of museum quality and culturally significant artworks for qualified participants.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-[37px] items-center">
              ...
              <div className="flex flex-col gap-4 p-10 bg-paper-white">
                <p>
                  ...
                  four complete collections.
                </p>
                <p>
                  Following a lifetime of serious medical challenges, John now lives with a condition for which there are
                  no further medical interventions. He continues forward with clarity, gratitude, and full awareness of the
                  limits of time.
                </p>
                <p>
                  With his creative output complete, John is focused on preservation, art therapy, and the thoughtful
                  stewardship of his work so that it may endure beyond his lifetime.
                </p>
                <p>
                  This creates a rare moment for collectors. Historically, the strongest recognition and appreciation of an
                  artist&apos;s work occurs once a body of work is closed. Here, acquisitions can be made while the artist is
                  still alive and directly involved in how his legacy is shaped.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[80px]">
            <div className="flex flex-col items-center gap-12 sm:gap-16 lg:gap-20">
              <div className="flex flex-col items-center gap-4 max-w-[995px]">
                <h2 className="text-center">Two Ways to Steward the Work</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 lg:gap-[34px] w-full max-w-[1198px]">
                <div className="flex flex-col gap-4 p-[60px_40px] lg:p-[80px_40px] min-h-[350px] lg:min-h-[429px] bg-white">
                  <h3>Fund Held Works</h3>
                  <p>
                    Selected works are acquired and stewarded within the Ethereum Art Fund as part of a governed, long
                    horizon strategy.
                  </p>
                  <p>These works are held to preserve cultural context, coherence, and long term significance.</p>
                </div>

                <div className="flex flex-col gap-4 p-[60px_40px] lg:p-[80px_40px] min-h-[350px] lg:min-h-[429px] bg-white">
                  <h3>Private Placement of Individual Works</h3>
                  <p>
                    Select works are made available for direct private acquisition by aligned collectors and institutions,
                    including hospitality, cultural, and architectural partners.
                  </p>
                  <p>These placements are approached with discretion and curatorial intent, not volume based sales.</p>
                  <p>Both paths operate under the same standards of care, provenance, and cultural responsibility.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="w-full bg-white py-12 sm:py-16 lg:py-[120px]">
          <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[80px]">
            <div className="flex flex-col items-center gap-4 mb-12 sm:mb-16 lg:mb-20 max-w-[995px] mx-auto">
              <h2 className="text-center">Stewardship Requires Accountability</h2>
              <p className="text-center">
                Art Investment Group Trust is governed by a board and leadership team with experience across art, culture,
                finance, and institutional stewardship. Oversight is intentional.
              </p>
              <p className="text-center">
                Responsibility is explicit. Art Investment Group Trust is not operated anonymously. Decisions are made by
                people accountable for long term outcomes.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center gap-10 sm:gap-12 lg:gap-10">
              ...
              <div className="text-center flex flex-col items-center gap-4">
                ...
                <p className="text-center max-w-[789px] mx-auto">
                  Art Investment Group Trust engages with collectors, institutions, and qualified participants through
                  direct, considered dialogue. We believe the stewardship of important art begins with thoughtful
