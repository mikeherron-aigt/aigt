        ...
        <section style={{ backgroundColor: "#ffffff" }}>
          <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[80px] py-14 sm:py-16 lg:py-20">
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
              {/* Copy */}
              <div>
                <p className="text-xs tracking-[0.22em] uppercase mb-4" style={{ color: "#A1A69D" }}>
                  Art Therapy
                </p>
                ...
                <p className="text-base sm:text-lg leading-relaxed mb-5" style={{ color: "#3a3a3a" }}>
                  ...
                  partner institutions, and community settings. The work is quiet by design: structured
                  sessions, trained facilitators, and environments that let art do what it does best.
                </p>
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="text-xs px-3 py-2 rounded-full border" style={{ borderColor: "#e6e6e6", color: "#5a5a5a" }}>
              ...
              <div className="w-full">
                <div
                  ...
                  style={{ backgroundColor: "#f5f5f5", border: "1px solid #ededed" }}
                >
