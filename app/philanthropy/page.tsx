...
const heroImage =
  "https://cdn.builder.io/api/v1/image/assets%2F5031849ff5814a4cae6f958ac9f10229%2FYOUR_PHILANTHROPY_HERO_IMAGE?format=webp&width=1200";
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#ffffff" }}>
        ...
        <main>
          <div className="max-w-[1440px] mx-auto relative">
            ...
            {/* Decorative Elements (VERTICAL BAR + deep green cube alignment)
               This is the EXACT pattern from your Home hero.
               It creates the vertical bar to the left of the image column.
            */}
            <div
          ...
          {/* DESIGN BAR (HORIZONTAL) - EXACTLY like Home
              Left: gallery plaster, Right: ledger stone, Center: deep patina square aligned with the vertical bar.
          */}
      ...
      <div className="w-full bg-white">
        ...
        {/* Stewardship is enforced through process (left headline + right stacked boxes) */}
        <section className="w-full bg-white py-12 sm:py-16 lg:py-24">
          <div className="max-w-[1440px] mx-auto">
            <div className="grid lg:grid-cols-[1fr_40%] gap-0">
              {/* Left */}
              <div className="px-4 sm:px-8 lg:px-[80px] flex flex-col justify-start">
                ...
                <div className="mt-6">
                  <Link
                    href="/stewardship"
                    className="cta-primary"
                    style={{ textDecoration: "none", width: "fit-content", display: "inline-flex" }}
                  >
